...
public class MoreOptionsScreen extends BaseScreen {
    ...
    public void rebuild() {
        ...
        ToggleButton btnShowFps = new ToggleButton(0, 0, BUTTON_WIDTH, BUTTON_HEIGHT, Gnetum.config.showHudFps, () -> I18n.get("gnetum.config.showFps") + ": %s");
        ...
        ToggleButton btnDownscale = new ToggleButton(0, 0, BUTTON_WIDTH, BUTTON_HEIGHT, Gnetum.config.downscale, () -> I18n.get("gnetum.config.downscale") + ": %s");
        btnDownscale.setTooltip(Tooltip.create(Component.translatable("gnetum.config.downscale.tooltip")));
        btnDownscale.setTooltipDelay(Duration.ZERO);
        ...
        IntSlider sliderMaxFps = new IntSlider(0, 0, BUTTON_WIDTH, BUTTON_HEIGHT, () -> I18n.get("gnetum.config.maxFps") + ": %s fps", 5, GnetumConfig.UNLIMITED_FPS, Gnetum.config.maxFps, 5, true, i -> Gnetum.config.maxFps = i, i -> i == 125, () -> I18n.get("gnetum.config.maxFps") + ": Unlimited");
