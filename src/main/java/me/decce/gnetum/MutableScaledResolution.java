...
public class MutableScaledResolution extends ScaledResolution {
	protected final Minecraft minecraftClient;
	protected double scaledWidthD;
	protected double scaledHeightD;
	protected int scaledWidth;
	protected int scaledHeight;
	protected int scaleFactor;

	public MutableScaledResolution() {
		this(Minecraft.getMinecraft());
	}

	public MutableScaledResolution(Minecraft minecraftClient) {
